...
<body>
    <nav class="nav">
        <a href="<?php echo e(url('/')); ?>" class="disabled">Home</a>
        <a href="<?php echo e(url('/statistics')); ?>">Statistics</a>
    </nav>
...
<script>
    ...
    function getHistory() {
        $.ajax({
            type: 'GET',
            url: '<?php echo e(url('/get-history')); ?>',
            dataType: 'json',
            success: function (response) {
                if (response.serviceResponse.success) {
...
</html><?php /**PATH C:\Users\Admin\Downloads\Files\Projects\Web\Laravel\wetter\resources\views/weather/index.blade.php ENDPATH**/ ?>